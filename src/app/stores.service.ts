...
export class StoresService {
  ...
  //////////////////////////////////////////////////////
    {
      name: 'Camelback Antiques',
      id: 1,
      address: [
        '2230 E. Indian School Rd, Phoenix, 85016',
      ],
      map: {lat: 33.495181, lng: -112.033190},
      tags: [
      ],
      description: 'Camelback Antiques is a 7,500-square foot multi-dealer mall in Central Phoenix. \
      <br/><br/>The store carries a wide selection of antique and vintage furniture, art, lighting, jewelry,\
       home décor, collectibles, and more.   In the courtyard, you will find garden furnishings and industrial items.\
       <br/><br/>Our experienced and professional dealers keep a constant, ever-changing variety of treasures in their \
       individual spaces. Camelback Antiques features many Phoenix’s favorite vendors. We maintain an active “wish list” and \
       are delighted to help match our customer’s wants with their sought-after items.\
       <br/><br/>Our staff is friendly and consists of knowledgeable dealers who are active doing shows and participating in \
       industry activities all over the country.\
       <br/><br/>Our owner, Stace Robbins, has long promoted the antiques business in the Phoenix area and is Vice President \
       of the Valley of the Sun Antique Dealer Association.\
       <br/><br/>Camelback Antiques is easy to find, has plenty of parking, and is close to many restaurants, retail \
       stores and other antique shops.  The mall is only 5 blocks off the AZ 51 freeway utilizing the Indian School Road exit.',
      hero: './assets/store-images/AOC/hero-f.jpg',
      pics: [
        './assets/store-images/AOC/8.jpg',
        './assets/store-images/AOC/3.jpg',
        './assets/store-images/AOC/4.jpg',
        './assets/store-images/AOC/5.jpg',
      ],
      social: {
        facebook: 'https://www.facebook.com/Camelback-Antiques-1214008385362338/',
        instagram: 'https://www.instagram.com/camelbackantiques/',
      },
      contact: {
        site: 'http://camelbackantiques.com',
        phone: '602-957-7357',
        email: 'info@camelbackantiques.com'
      },
      region: 'Phoenix'
    },
//////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////
    {
      ...
      id: 28,
      address: [
        '2230 E. Indian School Rd, Phoenix, 85012'
      ],
      map: {lat: 33.495181, lng: -112.033190},
      tags: [
        'Dealer',
      ],
      description: 'In Scottsdale<br /><br />Antique Trove 2020 N. Scottsdale Rd.<br />(Between Thomas & McDowell)<br /><br />\
        Beautifully Celebrated, space 303, is your designated source for celebrating all of life\'s lovely moments.\
        Whether for home, staging, weddings, mitzvahs, showers, births, birthdays or parties - Come take a look~ and let \
        the celebrations begin!<br /><br />Beautifully Disheveled, space 1128, is a fresh mix of antique things, uncommon \
        things and vintage things with all the attitude and personality customers have experienced.<br /><br />In Phoenix<br /><br />\
        Camelback Antiques 2230 E. Indian School Rd.<br /><br />Beautifully Imperfect, space 505, is a country cottage / farmhouse theme- \
        for all of your unnecessary necessities for self & home.<br /><br />Dealer... Lori Marcus',
      hero: './assets/store-images/AOC/hero-f.jpg',
      pics: [
        './assets/store-images/AOC/hero-f.jpg',
      ],
      social: {
      },
      contact: {
        email: 'ldzenner@aol.com'
      },
      region: 'Phoenix'
    },
    //////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////
    {
      ...
      pics: [
        ...
        './assets/store-images/MA/5.jpg',
        './assets/store-images/MA/6.jpg',
        './assets/store-images/MA/7.jpg',
        './assets/store-images/MA/8.jpg',
        './assets/store-images/MA/9.jpg',
        './assets/store-images/MA/10.jpg',
        './assets/store-images/MA/11.jpg',
        './assets/store-images/MA/12.jpg',
        './assets/store-images/MA/13.jpg',
        './assets/store-images/MA/14.jpg',
      ],
      social: {
